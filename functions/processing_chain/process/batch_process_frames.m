function [dab_frames, frame_count, iq_data_meas] = ...
        batch_process_frames(file_name, frame_count_max,dab_mode, fs, type)
    % ---------------------------------------------------------------------    
    ...
    %% PRE-ALLOCATION
    dab_frames = zeros(frame_count_max, (dab_mode.Tf)*dab_mode.F_intra + (dab_mode.T_intra)*(dab_mode.F_intra-1));
